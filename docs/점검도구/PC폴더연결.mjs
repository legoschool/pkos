...
try {
 for(let i=0;i<100&&!await evaluate(`window.pkosLocal&&pkosLocal.isOn()`);i++)await wait(100);
 check('PC 연결 프로그램에 자동 연결',await evaluate(`pkosLocal.isOn()`));
